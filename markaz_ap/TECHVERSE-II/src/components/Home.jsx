...
// Note: Adjust the dependency array inside the useEffect if re-fetching based on certain conditions
                      ...
                      <Grid key={product.id} item xs={12} md={4} lg={3}>
                        <Card style={{ marginTop: '1rem' }} sx={{ maxWidth: 345 }}>
                          <CardMedia
                            ...
                            alt={product.item}
                            height="300"
                            image={img7} // Assuming the image path is a string
                          />
                          <CardContent>
                          ...
                          <CardActions>
                            ...
                            <div style={{ display: 'flex', gap: '7rem' }}>
                              ...
                              <Tooltip title="Download Product">
                                  ...
                                  <ArrowDownwardIcon onClick={() => downloadImage(product.image, product.item)} />
